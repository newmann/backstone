...
public class AreaUtils {
	...
	public static String getAreaId(HttpServletRequest request, HttpServletResponse response) {
		String areaId = com.beiyelin.shop.common.utils.CookieUtils.getCookie(request, COOKIE_NAME_AREA_ID);
		if (StringUtils.isBlank(areaId)) {
			areaId = Area.DEFAULT_AREA_ID;
			com.beiyelin.shop.common.utils.CookieUtils.setCookie(response, COOKIE_NAME_AREA_ID, areaId, "/", CookieUtils.COOKIE_DEFAULT_AGE);
		}
