 ...
 */
package com.beiyelin.shop.modules.act.service.ext;
...
public class ActUserEntityService extends UserEntityManager {
	...
	public void insertUser(com.beiyelin.shop.modules.sys.entity.User user) {
...
//			user.delete();
//		}
		org.activiti.engine.identity.User user = findUserById(userId);
		if (user != null) {
			getSystemService().deleteUser(new com.beiyelin.shop.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.beiyelin.shop.modules.sys.entity.User(null, userId)))){
