...
import com.beiyelin.shop.modules.shop.service.CookieService;
...
public class CookieUtils {
	...
	public static String getCookieId(HttpServletRequest request, HttpServletResponse response) {
		String cookieId = com.beiyelin.shop.common.utils.CookieUtils.getCookie(request, CookieUtils.COOKIE_ID_NAME);
		...
		if (StringUtils.isBlank(cookieId)) {
			...
			// set to client
			com.beiyelin.shop.common.utils.CookieUtils.setCookie(response, CookieUtils.COOKIE_ID_NAME, cookieId, "/", COOKIE_DEFAULT_AGE);
		}
