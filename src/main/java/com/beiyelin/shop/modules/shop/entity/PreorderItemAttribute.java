 ...
 * @author Tony Wong
 */
public class PreorderItemAttribute extends DataEntity<PreorderItemAttribute> {

	private static final long serialVersionUID = 1L;

	private PreorderItem item;
    ...
    public void setItem(PreorderItem item) {
        this.item = item;
    }
